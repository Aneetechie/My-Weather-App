...
document.getElementById('displayName').innerHTML = `<div class="text-center fw-semibold m-3" style="font-size: 1.4rem; "><span class="fw-bold text-light">Hi, ${name}!</span> Welcome to thyWeather App.☀️</div>`
...
loader.classList.remove('d-none');  
    ...
    function displayWeather(data) { 
        ...
        if (data.cod === '404') { 
            ...
            displayCityWeather.innerHTML = `<p class = "text-center fw-bold display-5">City not found</p>` 
